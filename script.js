...
// SINKRONISASI PDF: Fix Potong & Multi-page
function generatePDF(lvlNum, avgs) {
    ...
    // Menggunakan tinggi kontainer tetap (1120px) agar muat di A4
    wrapper.innerHTML = `
        <div id="pdf-container" style="width:794px; height:1120px; padding:35px; background:#fff; border:15px solid #0056b3; box-sizing:border-box; position:relative; font-family:Arial, sans-serif; overflow:hidden; display:flex; flex-direction:column;">
            ...
            <div style="position:absolute; top:0; left:0; width:100%; height:100%; opacity:0.03; pointer-events:none; z-index:0; display:flex; flex-wrap:wrap; align-content:space-around; justify-content:space-around; transform: rotate(-25deg) scale(1.2);">
                ${Array(12).fill('<img src="logo-araya.png" style="width:140px; margin:50px;">').join('')}
            </div>
            ...
            <div style="text-align:center; position:relative; z-index:1; margin-bottom: 20px;">
                ...
                <h2 style="margin:0; font-size:22px; letter-spacing:2px; border-bottom: 2px solid #333; display: inline-block;">LAPORAN ANALISIS KEPEMIMPINAN</h2>
                <p style="margin:10px 0 5px 0;">Diberikan kepada:</p>
                <h1 style="margin:0; font-size:32px; font-weight:bold; text-transform: uppercase;">${userData.name}</h1>
                <div style="background:#1e293b; color:#fff; display:inline-block; padding:10px 40px; border-radius:8px; margin-top:15px; font-size:18px; font-weight:bold;">
                    HASIL UTAMA: ${info.title.toUpperCase()}
                </div>
            </div>

            <div style="position:relative; z-index:1; flex-grow:1;">
                <h4 style="margin:0 0 5px 0; font-size:16px; color:#0056b3; border-bottom:2px solid #eee;">Leadership Insight:</h4>
                <p style="font-size:13px; line-height:1.5; margin:0 0 15px 0; text-align:justify;">${info.desc} ${info.insight}</p>

                <h4 style="margin:0 0 5px 0; font-size:16px; color:#0056b3; border-bottom:2px solid #eee;">Gaya Komunikasi:</h4>
                <p style="font-size:13px; line-height:1.5; margin-bottom:15px;">${info.komunikasi}</p>

                <div style="display:grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 15px;">
                    <div>
                        <h4 style="margin:0 0 5px 0; font-size:16px; color:#28a745; border-bottom:2px solid #eee;">Kekuatan Utama (+):</h4>
                        <p style="font-size:13px; line-height:1.4;">${info.kekuatan}</p>
                    </div>
                    <div>
                        <h4 style="margin:0 0 5px 0; font-size:16px; color:#dc3545; border-bottom:2px solid #eee;">Area Pengembangan (-):</h4>
                        <p style="font-size:13px; line-height:1.4;">${info.kelemahan}</p>
                    </div>
                </div>

                <h4 style="margin:0 0 5px 0; font-size:16px; color:#d9534f; border-bottom:2px solid #eee;">Strategi Pengembangan 90 Hari:</h4>
                <div style="background:#fffcf5; padding:12px; border-radius:8px; border:1px solid #ffeeba;">
                    <p style="font-size:13px; line-height:1.5; margin:0; font-style:italic; color: #856404;">${info.rec}</p>
                </div>

                <h4 style="margin:20px 0 5px 0; font-size:16px; color:#0056b3; border-bottom:2px solid #eee;">Dinamika Skor Kepemimpinan:</h4>
                <table style="width:100%; font-size:13px; border-collapse: collapse;">
                    <tr style="border-bottom:1px solid #eee;"><td style="padding:4px 0;">Level 1: Position</td><td style="text-align:right;"><b>${avgs.L1}</b></td></tr>
                    <tr style="border-bottom:1px solid #eee;"><td style="padding:4px 0;">Level 2: Permission</td><td style="text-align:right;"><b>${avgs.L2}</b></td></tr>
                    <tr style="border-bottom:1px solid #eee;"><td style="padding:4px 0;">Level 3: Production</td><td style="text-align:right;"><b>${avgs.L3}</b></td></tr>
                    <tr style="border-bottom:1px solid #eee;"><td style="padding:4px 0;">Level 4: People Development</td><td style="text-align:right;"><b>${avgs.L4}</b></td></tr>
                    <tr style="border-bottom:1px solid #eee;"><td style="padding:4px 0;">Level 5: Pinnacle</td><td style="text-align:right;"><b>${avgs.L5}</b></td></tr>
                </table>
            </div>
            ...
            <div style="margin-top:20px; display:flex; justify-content:space-between; align-items:flex-end; position:relative; z-index:1;">
                <div style="font-size:12px; color:#666;">
                    <p style="margin:0;">ID Laporan: LEAD-${Math.floor(Date.now()/1000)}</p>
                    <p style="margin:3px 0;">Tanggal: ${dateStr}</p>
                    <p style="font-weight:bold; color:#0056b3; margin:0;">Araya Consulting - Your Growth Partner</p>
                </div>
                <div style="text-align:center;">
                    <p style="margin:0; font-size:13px;">Disahkan oleh,</p>
                    <img src="ttd.png" style="width:130px; margin: 5px auto; display:block;">
                    <p style="margin:0; font-weight:bold; font-size:18px; border-top:2px solid #000; display:inline-block; padding: 5px 15px 0 15px;">ALI MAHFUD</p>
                    <p style="margin:3px 0 0 0; font-size:12px; color:#666; font-weight:bold;">Founder Araya Consulting</p>
                </div>
            </div>
        </div>`;
